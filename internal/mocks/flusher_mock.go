...
// Source: github.com/ozoncp/ocp-offer-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Offer) ([]models.Offer, error) {
	m.ctrl.T.Helper()
